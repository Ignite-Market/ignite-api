    ...
    'inputs': [
      {
        'components': [
          {
            'internalType': 'uint32',
            'name': 'initialRewardEpochId',
            'type': 'uint32'
          },
          {
            'internalType': 'uint32',
            'name': 'startingVotingRoundIdForInitialRewardEpochId',
            'type': 'uint32'
          },
          {
            'internalType': 'bytes32',
            'name': 'initialSigningPolicyHash',
            'type': 'bytes32'
          },
          {
            'internalType': 'uint8',
        ...
        'internalType': 'struct IRelay.RelayInitialConfig',
        'name': '_initialConfig',
        'type': 'tuple'
      },
      {
