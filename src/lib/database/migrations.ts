...
export async function setupDatabase(database: string, host: string, port: number, user: string, password: string): Promise<void> {
  if (!dbMigration) {
...
export async function upgradeDatabase(database: string, host: string, port: number, user: string, password: string, steps?: number): Promise<void> {
  if (!dbMigration) {
    await initMigrations(database, host, port, user, password);
  }
...
export async function downgradeDatabase(database: string, host: string, port: number, user: string, password: string, steps?: number): Promise<void> {
  if (!dbMigration) {
    await initMigrations(database, host, port, user, password);
  }
...
export async function clearDatabase(database: string, host: string, port: number, user: string, password: string): Promise<void> {
...
export async function rebuildDatabase(database: string, host: string, port: number, user: string, password: string): Promise<void> {
  if (!dbMigration) {
    await initMigrations(database, host, port, user, password);
  }
...
export async function dropDatabase(database: string, host: string, port: number, user: string, password: string): Promise<void> {
...
export async function seedDatabase(database: string, host: string, port: number, user: string, password: string, steps?: number): Promise<void> {
  if (!seedMigration) {
    await initMigrations(database, host, port, user, password);
  }
...
export async function unseedDatabase(database: string, host: string, port: number, user: string, password: string, steps?: number): Promise<void> {
  if (!seedMigration) {
    await initMigrations(database, host, port, user, password);
  }
