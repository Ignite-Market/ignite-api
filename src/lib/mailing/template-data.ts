...
export function generateTemplateData(key: string, data: any) {
  const templateData = {
    [EmailTemplateType.EMAIL_VERIFICATION]: {
      ...
      title: 'Greetings from Ignite Market!',
      text: `
      <p>
      ...
      text2: `
      <p>
        If you need additional assistance, or you received this email in error, please contact us at <a href="mailto:info@ignitemarket.xyz">info@ignitemarket.xyz</a>.
        <br/><br/><br/>
        Cheers,<br/>
